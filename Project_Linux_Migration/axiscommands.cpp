...
QString AxisCommands::reset() {
    return "$A9%";
}

QString AxisCommands::setSpeed(QString axis, QString speed) {
    QString command = "$B40" + axis + speed + "%";
    return command;
}
QString AxisCommands::setAbsMove(QString axis, QString position) {
    QString command = "$B60" + axis + position + "%";
    return command;
}

QString AxisCommands::enableJoy() {
    return "$BE%"; //ENABLE_JOY $BE%; resp [!BE#];
}
QString AxisCommands::disableJoy() {
    return "$BF%"; //DISABLE_JOY $BF%; resp [!BF#];
}

void AxisCommands::getXMaxSpeed() {
...
void AxisCommands::getYMaxSpeed() {
...
void AxisCommands::getZMaxSpeed() {
...
void AxisCommands::getPlasmaHeadXCoordinate() {
...
void AxisCommands::getPlasmaHeadYCoordinate() {
...
void AxisCommands::getPlasmaHeadZCoordinate() {
...
void AxisCommands::getPlasmaLaserXCoordinate() {
...
void AxisCommands::getPlasmaLaserYCoordinate() {
...
void AxisCommands::getPHSlitLength() {
...
void AxisCommands::getPHSlitWidth() {
...
void AxisCommands::getPHSafetyZGap() {
...
void AxisCommands::getZPinsBuried() {
...
void AxisCommands::getZPinsExposed() {
...
void AxisCommands::getLoadX2Base() {
...
void AxisCommands::getLoadY2Base() {
...
void AxisCommands::getLoadZ2Base() {
